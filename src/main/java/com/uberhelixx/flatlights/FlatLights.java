...
public class FlatLights
{
    ...
    private void setup(final FMLCommonSetupEvent event)
    {
        ...
        List<Item> itemOrder = Arrays.asList(
                ...
                ModBlocks.SHIFTED_PURPLE_FLATBLOCK.get().asItem(),
                ...
                ModBlocks.SHIFTED_PURPLE_PANEL.get().asItem(),
                ...
                ModBlocks.SHIFTED_PURPLE_PILLAR.get().asItem(),
                ...
                ModBlocks.SHIFTED_PURPLE_HORIZONTAL_EDGE.get().asItem(),
                ...
                ModBlocks.SHIFTED_PURPLE_VERTICAL_EDGE.get().asItem(),
