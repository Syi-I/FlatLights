...
public class PlatingMachineContainer extends Container {
    ...
    public PlatingMachineContainer(int windowId, World world, BlockPos pos, PlayerInventory playerInventory, PlayerEntity player) {
        super(ModContainers.PLATING_MACHINE_CONTAINER.get(), windowId);
