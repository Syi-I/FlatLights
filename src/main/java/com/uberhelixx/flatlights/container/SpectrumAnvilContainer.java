...
public class SpectrumAnvilContainer extends AbstractRepairContainer {
    ...
    protected ItemStack func_230301_a_(PlayerEntity p_230301_1_, ItemStack p_230301_2_) {
        ...
        float breakChance = net.minecraftforge.common.ForgeHooks.onAnvilRepair(p_230301_1_, p_230301_2_, this.field_234643_d_.getStackInSlot(0), this.field_234643_d_.getStackInSlot(1));
    ...
    public void updateRepairOutput() {
        ...
        if (itemstack.isEmpty()) {
            ...
            if (!itemstack2.isEmpty()) {
                if (!onSpectrumAnvilChange(this, itemstack, itemstack2, field_234642_c_, repairedItemName, j, this.field_234645_f_)) return;
    ...
    public static boolean onSpectrumAnvilChange(SpectrumAnvilContainer container, @Nonnull ItemStack left, @Nonnull ItemStack right, IInventory outputSlot, String name, int baseCost, PlayerEntity player)
    {
