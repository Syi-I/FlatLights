...
public class LightStorageContainer extends Container {
    ...
    public LightStorageContainer(int windowId, World world, BlockPos pos, PlayerInventory playerInventory, PlayerEntity player) {
        super(ModContainers.LIGHT_STORAGE_CONTAINER.get(), windowId);
        ...
        if (tileEntity != null) {
            ...
            {
                addSlotBox(h, 0, 5 - xOff, 5 - yOff, 13, 18, 9, 18);
            });
        }
    }
    ...
    private static final int TE_INVENTORY_SLOT_COUNT = 13 * 9;  // must match TileEntityInventoryBasic.NUMBER_OF_SLOTS
