...
public class BlackoutHorizontalEdgeBlock extends Block implements IWaterLoggable {
    ...
    public BlackoutHorizontalEdgeBlock(double thickness) {
        super(Properties.create(Material.GLASS)
                .hardnessAndResistance(BLOCK_HARDNESS, BLOCK_RESISTANCE)
                .setLightLevel(EDGE_BLOCK_LIGHT_LEVEL)
                .notSolid()
                .setOpaque(BlackoutHorizontalEdgeBlock::isntSolid)
