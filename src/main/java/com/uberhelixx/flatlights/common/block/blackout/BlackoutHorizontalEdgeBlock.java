...
public class BlackoutHorizontalEdgeBlock extends HorizontalEdgeBlock {
    public BlackoutHorizontalEdgeBlock(ToIntFunction<BlockState> lightLevel, double thickness) {
