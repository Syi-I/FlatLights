...
public class BlackoutVerticalEdgeBlock extends Block implements IWaterLoggable {
    private final double thickness;
    static final float BLOCK_HARDNESS = 0.4f;
    static final float BLOCK_RESISTANCE = 100000000f;
    public static ToIntFunction<BlockState> EDGE_BLOCK_LIGHT_LEVEL = BlockState -> 7;

    public BlackoutVerticalEdgeBlock(double thickness) {
        super(Properties.create(Material.GLASS)
                .hardnessAndResistance(BLOCK_HARDNESS, BLOCK_RESISTANCE)
                .setLightLevel(EDGE_BLOCK_LIGHT_LEVEL)
                .notSolid()
                .setOpaque(BlackoutVerticalEdgeBlock::isntSolid)
    ...
    public BlockState getStateForPlacement(BlockItemUseContext context) {
        ...
        if (context.getPlayer() != null && worldIn.getBlockState(pos).getBlock() instanceof BlackoutVerticalEdgeBlock && context.getPlayer().isCrouching()) {
