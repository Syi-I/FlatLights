...
public class SpectrumAnvilScreen extends AbstractRepairScreen<SpectrumAnvilContainer> {
    ...
    public SpectrumAnvilScreen(SpectrumAnvilContainer container, PlayerInventory playerInventory, ITextComponent title) {
        super(container, playerInventory, title, SPECTRUM_ANVIL_RESOURCE);
        this.titleX = 60;
    }
    public void tick() {
        super.tick();
    ...
    protected void initFields() {
        ...
        this.nameField = new TextFieldWidget(this.font, i + 62, j + 24, 103, 12, ITextComponent.getTextComponentOrEmpty("Spectrum Anvil"));
