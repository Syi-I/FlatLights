...
public class BasicColorParticle extends TextureSheetParticle {
    private final BasicColorParticleConstructor constructor;
    
    public BasicColorParticle(ClientLevel pLevel, double pX, double pY, double pZ, double pXSpeed, double pYSpeed, double pZSpeed, BasicColorParticleConstructor constructor) {
        super(pLevel, pX, pY, pZ, pXSpeed, pYSpeed, pZSpeed);
        
        setColor(constructor.getColor().getRed() / 255F,
                constructor.getColor().getGreen() / 255F,
                constructor.getColor().getBlue() / 255F);
    ...
    private static final ParticleRenderType RENDERER = new ParticleRenderType() {
        ...
        public String toString() {
            return FlatLights.MODID + ":" + "basic_color";
        }
    };
}
