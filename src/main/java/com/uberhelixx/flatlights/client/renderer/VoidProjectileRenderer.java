...
public class VoidProjectileRenderer extends EntityRenderer<VoidProjectileEntity> {
    ...
    @Override
    public void render(VoidProjectileEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
