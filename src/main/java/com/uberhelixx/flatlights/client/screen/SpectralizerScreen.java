...
import com.uberhelixx.flatlights.common.container.SpectralizerContainer;
...
public class SpectralizerScreen extends ContainerScreen<SpectralizerContainer> {
    private final ResourceLocation GUI = new ResourceLocation(FlatLights.MODID, "textures/gui/spectralizer_gui.png");
